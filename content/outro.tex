...
\lstinputlisting[language=Matlab, firstline=15, lastline=41,
  caption={Bộ giải FISTA nội, trả về toàn bộ vết lặp (tệp \texttt{inner\_fista\_trace.m}).}]
  {matlab/inner_fista_trace.m}

\lstinputlisting[language=Matlab, firstline=46, lastline=68,
  caption={Vòng lặp ngoài chính (trích từ \texttt{run\_outer.m}).}]
  {matlab/run_outer.m}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{matlab/So sanh toc do hoi tu.pdf}
...
\begin{slidesonly}
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{matlab/So sanh toc do hoi tu.pdf}
