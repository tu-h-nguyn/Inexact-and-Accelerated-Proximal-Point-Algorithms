...
z^3+z-y=0.
\]
Nghiệm này được tính bằng phương pháp Brent với sai số tuyệt đối $10^{-15}$ và sai số tương đối $10^{-14}$. Vì vẫn sử dụng một bộ giải số, đường tương ứng được gọi là \emph{thuật toán tham chiếu}, không gọi là thuật toán chính xác.
...
\end{equation}
Các phương trình \eqref{eq:type1-boundary} và \eqref{eq:type2-boundary} đều được giải bằng phương pháp Brent. Mỗi phương trình có hai nghiệm nằm ở hai phía của điểm cận kề; nghiệm có giá trị $F$ lớn hơn được chọn để tránh chủ động tạo một nhiễu có lợi. Tỉ số giữa vế trái và vế phải của phương trình biên được lưu lại như một chứng chỉ kiểm tra.

\subsection{Kết quả}

\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{figures/objective_convergence.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{figures/error_accumulation.png}
...
\hline
IAPPA1, $q=7/4$ & $6.067\times10^{-10}$ & $-0.521$ & $1.4\times10^{-9}$ \\
\hline
IAPPA2, $q=7/4$ & $7.440\times10^{-16}$ & $-1.989$ & $2.3\times10^{-6}$ \\
\hline
\end{tabular}
\end{table}
